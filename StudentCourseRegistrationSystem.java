...
public class StudentCourseRegistrationSystem {
    static void main(String[] args) {
        ...
        studentDatabase.addStudent(new Student("1001", "mouni"));
        studentDatabase.addStudent(new Student("1002", "sasi"));
        studentDatabase.addStudent(new Student("1003", "swathi"));
        studentDatabase.addStudent(new Student("1004", "kiran"));
        studentDatabase.addStudent(new Student("1005", "punya"));
        studentDatabase.addStudent(new Student("1006", "lavanya"));
        studentDatabase.addStudent(new Student("1007", "bhavani"));
